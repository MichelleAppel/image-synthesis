...
python ./cyclegan/train.py --dataroot $data_root_fake_train --use_wandb --name $run_name --batch_size 16 --load_size 448 --crop_size 448 --gpu_ids $1
