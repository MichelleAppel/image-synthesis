...
if __name__ == "__main__":
    ...
    parser.add_argument('--device', type=str, default='cuda',
                        help='Run on device (default: cuda)')
    ...
    vtrain_loader = None # DataLoader(vtrain, **params, shuffle=False)
    vval_loader = None # DataLoader(vval, **params, shuffle=False)

    dataset = SynthesisDataset("..\..\..\Project\simulation-synthesis\output\MLDataset", extension='.png')
