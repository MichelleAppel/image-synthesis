...
class SynthesisDataset(Dataset):
    """The dataset for the real data

    """
    def __init__(self, root_dir, scale=1.0, extension='.png', id_grouping=True, do_domain_transfer=True, net_G_path='fake2real_608x448'):
        ...
        if self.do_domain_transfer:
            ...
            load_path = os.path.join("checkpoints", net_G_path, "latest_net_G_A.pth")
