...
$data_root_fake_train = "..\simulation-synthesis\output\"+$img_size+"\labeled_fake"
$data_root_real_train = "..\simulation-synthesis\output\"+$img_size+"\labeled_real"
$data_root_fake_test = "..\simulation-synthesis\output\"+$img_size+"\labeled_fake_test"
$data_root_real_test = "..\simulation-synthesis\output\"+$img_size+"\labeled_real_test"

$batch_size = 1

# python .\cyclegan\train.py --dataroot $root --use_wandb --name $run_name --batch_size 1 --load_size 448 --crop_size 448
